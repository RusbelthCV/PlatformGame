...
function preload ()
{
    ...
    this.load.image('ground', 'Tiles_64x64/Tiles_64x64.png');
    //this.load.image('items', 'assets/tilemaps/tiles/kenny_items_64x64.png');
    //this.load.image('platformer', 'Tiles 64x64/Tiles_64x64.png');

    this.load.tilemapTiledJSON('map', 'mapa.json.tmx');
}
...
function create ()
{
    ...
    var groundTiles = map.addTilesetImage('Tiles_64x64', 'ground')
